...
""")
    ...
    if message.content.startswith("r!ghost"):
        args = message.content.split(" ")
        await client.send_message(discord.Object(id='414625413915082754'), "%s" % (" ".join(args[1:])))
...
r!changegame - *Give Romani a new game!*""")
    ...
    if message.content.startswith("r!fatekin"):
        if message.author.id == "208017434374963200":
            ...
            await client.send_message(message.channel, msg + " Your Chaldea assigned kin is... %s" % furrykin)
